...
class DonnéespersonnellesController extends AbstractController
{
    #[Route('donnespersonnelles', name: 'donnespersonnelles')]
    ...
    {   $newsletter = new Newsletter();
        ...
        return $this->render('front/donnéespersonnelles/index.html.twig', [
