...
class Banner
{
     ...
     * 
     * @Vich\UploadableField(mapping="banner", fileNameProperty="image1")
     * 
     * @var File|null
     */
    private $imageFile1;
     ...
     * NOTE: This is not a mapped field of entity metadata, just a simple property.
     * 
     * @Vich\UploadableField(mapping="banner", fileNameProperty="image2")
     * 
     * @var File|null
     */
    private $imageFile2;
     ...
     * NOTE: This is not a mapped field of entity metadata, just a simple property.
     * 
     * @Vich\UploadableField(mapping="banner", fileNameProperty="image3")
     * 
     * @var File|null
     */
    private $imageFile3;
